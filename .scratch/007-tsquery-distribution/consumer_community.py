...
Person ground truth — checks active, no tsgrammar in the process.
...
from tscore.schema import NodeSchema  # noqa: E402
from tsquery import Language, M, OutputModel, source_meta  # noqa: E402

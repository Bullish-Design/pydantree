...
The hand-written reference grammar (.scratch/004-grammar/reference/
...
ROOT = Path(__file__).resolve().parent          # .scratch/004-grammar
REPO = ROOT.parent.parent
SRC = REPO / "src"
sys.path.insert(0, str(SRC))

from pydantree_sitter_grammar.ir import Grammar           # noqa: E402  (the IR)
from pydantree_sitter_grammar.language import parse            # noqa: E402
from pydantree_sitter_grammar.pipeline import compile_parser, run_generate  # noqa: E402

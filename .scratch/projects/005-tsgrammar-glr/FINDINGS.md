...
`src/tsgrammar/` (builder ladder + per-production sites, `expressions.py`,
...
```bash
devenv shell -- python .scratch/005-tsgrammar-glr/experiment_phase3.py
...
`qfilter` (`.scratch/005-tsgrammar-glr/qfilter.py`) — a query/filter language

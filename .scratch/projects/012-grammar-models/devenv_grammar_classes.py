...
The surface — each rule is a class; the class body IS the production:
  ...
  * class attributes carry the flags and leaf forms: `__pattern__` (regex),
    `__token__`, `__external__`, `__extra__`, `__supertype__`, `__hidden__`,
    `__inline__`, `__word__`, `__rule_name__` (builtin-name escape).

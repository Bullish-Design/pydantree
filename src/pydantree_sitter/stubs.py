"""pydantree_sitter.stubs — Job 2: typed node accessors generated from the node-schema.
...
from pydantree_sitter.schema import NodeSchema, NodeTypeRef
...
def generate_stubs(schema: NodeSchema, *, lang_name: str | None = None,
    ...
    lines.append(f"# Typed node accessors for "
                 ...
                 f"the node-schema (pydantree_sitter.stubs).")

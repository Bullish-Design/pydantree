...
The loading contract lives in `tscore.loader` (CONCEPT §8: tscore owns the
...
def load_language(so_path, grammar_name: str | None = None):
    ...
    Delegates to tscore.loader.load_grammar_so (the shared contract — a
    ...
    """
    from tscore.loader import load_grammar_so
